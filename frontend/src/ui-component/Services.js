          ...
          <div className="row margin-t-30">
            <div className="col-lg-4 margin-t-20">
              <div className="services-box text-center hover-effect">
                ...
                <p className="padding-targett-15 text-muted">
                  Describe your presenting style and get amazing themes that fit your needs.
                </p>
              </div>
            </div>
            <div className="col-lg-4 margin-t-20">
              <div className="services-box text-center hover-effect">
                ...
                <h4 className="padding-t-15">Generate and cutomize</h4>
                <p className="padding-t-15 text-muted">
                  Load your research, generate slides, and edit to perfection.
                </p>
              </div>
            </div>
            <div className="col-lg-4 margin-t-20">
